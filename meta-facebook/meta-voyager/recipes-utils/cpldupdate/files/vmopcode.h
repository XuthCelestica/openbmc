...
#define GPIOF_OFFSET (0x1 << 8)
#define CPLD_UPDATE_GPIOF_ENABLE (0x1 << 24)
#define CPLD_JTAG_GPIOM_ENABLE (0xf << 24)
#define BMC_GPIOM0 (0)
#define BMC_GPIOM1 (1)
#define BMC_GPIOM2 (2)
#define BMC_GPIOM3 (3)
#define CPLD_TMS_CONFIG BMC_GPIOM0
#define CPLD_TDI_CONFIG BMC_GPIOM1
#define CPLD_TCK_CONFIG BMC_GPIOM2
#define CPLD_TDO_CONFIG BMC_GPIOM3
